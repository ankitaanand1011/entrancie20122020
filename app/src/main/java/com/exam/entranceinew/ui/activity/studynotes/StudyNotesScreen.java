...
public class StudyNotesScreen extends AppCompatActivity {
    ...
    private void notes_list() {
        mView.showDialog();
        final String tag_string_req = "notes_list";
        String url = ApplicationConstants.notes_list;
        ...
        try {
            ...
            Log.d(TAG, "notes_list: js >  "+js.toString());
        }catch (Exception e){
            e.printStackTrace();
        }
        try{
            JsonObjectRequest jsonObjReq = new JsonObjectRequest(
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject jobj) {
                            Log.d(TAG, "notes_list Response: " + jobj);
                            ...
                            try {
                                ...
                                if(result.equals("true")) {
                                    ...
                                    JSONArray subject_list = data.getJSONArray("subject_list");
                                    ...
                                    rvStudyNotes.setLayoutManager(new LinearLayoutManager(StudyNotesScreen.this, LinearLayoutManager.VERTICAL, false));
                                    studyNotesAdapter = new StudyNotesAdapter(StudyNotesScreen.this, arr_study);
                                    rvStudyNotes.setAdapter(studyNotesAdapter);
                                    ...
                                    mView.hideDialog();
                                    Toast.makeText(StudyNotesScreen.this, message, Toast.LENGTH_LONG).show();
                                }
            ...
            globalClass.addToRequestQueue(StudyNotesScreen.this, jsonObjReq, tag_string_req);
